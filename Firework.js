...
var Firework = {//烟花类
		getInstance : function(){//实例化方法
			var firework = {},
				...
				fireworkType = createHeartFirework,//爆炸后烟花的形状,默认为圆形
...
function createDoubleHeartFirework(firework){//创建一箭穿心形烟花
	var inBalst = firework.getInBalst(),
		...
		resistance = firework.getResistance(),
		afterBalstList = [];
		var quiescence = new Object();
		quiescence.x = 400.6076076187144;
		quiescence.y = 800.2324183793012;
	...
	for(let i = 0; i < num; i++){//绘制箭头,用一个横着的桃心形爱心模拟箭头							
		...
		console.log(quiescence.x+","+quiescence.y)
		afterBalstCopy.setBase();
		afterBalstList.push(afterBalstCopy);
	}
	firework.setAfterBalstList(afterBalstList);
...
function createCustomFirework(firework){//绘制自定义烟花
	var inBalst = firework.getInBalst(),
		...
		delay = 0;
		var quiescence = new Object();
		quiescence.x = 500.6076076187144;
		quiescence.y = 1081.2324183793012;
...
var word = ["陈","秋","丽","生","日","快","乐"];
var word_position = [-300,0,//陈 的位置
                     0,0,//秋 的位置
                     300,0,//丽 的位置
                     -375,250,//生 的位置
                     -125,250,//日 的位置
...
var word_matrix = {陈 : [
        	[-4,-5],[-3,-5],[-2,-5],[-1,-5],
			[-1.5,-4],[-2,-3.5],[-2.5,-3],[-3,-2.5],[-2.5,-2],[-2,-1.5],[-1.5,-1],[-2,-1],[-3,-1],[-3.5,-1],
			[-4,-4],[-4,-3],[-4,-2],[-4,-1],[-4,0],[-4,1],[-4,2],[-4,3],[-4,4],
			[1,-4],[2,-4],[3,-4],[4,-4],
			[2.5,-5],[2,-4],[1.5,-3],[1,-2.5],[0.5,-2],
			[1.5,-2],[2,-2],[3,-2],[4,-2],
			[2.5,-3],[2.5,-2],[2.5,-1],[2.5,0],[2.5,1],[2.5,2],[2.5,3],[2.5,4],
			[2,3],[1.5,2.5],[1,2],
			[1,-0.5],[0.5,0],[0,1],
			[4,-0.5],[4.5,0],[5,1],
        ], 秋 : [
			[-1,-5],[-2,-4.6],[-3,-4.2],[-4,-3.8],
			[0,-2],[-1,-2],[-2,-2],[-3,-2],[-4,-2],[-5,-2],
			[-2.5,-4],[-2.5,-3],[-2.5,-2],[-2.5,-1],[-2.5,0],[-2.5,1],[-2.5,2],[-2.5,3],[-2.5,4],
			[-2.5,-2],[-3,-1.5],[-3.5,-1],[-4,-0.5],[-4.5,0],
			[-2.5,-2],[-2,-1.5],[-1.5,-1],[-1,-0.5],
			[1.5,-2.5],[1.5,-2],
			[2.5,-5],[2.5,-4],[2.5,-3],[2.5,-2],[2.5,-1],
			[2.5,0],[3,0.5],[2.5,1],[2,1.5],[1.5,2.5],[1,3.5],[0.5,4.5],
			[2.5,0],[2,0.5],[2.5,1],[3,1.5],[3.5,2.5],[4,3.5],[4.5,4.5],
			[4.5,-3.5],[4,-3],[3.5,-2.5]
        ], 丽 : [
